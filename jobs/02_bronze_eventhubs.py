...
bootstrap_servers = dbutils.secrets.get(scope="medlake-kv", key="eventhub-bootstrap-servers")
eventhub_name = dbutils.secrets.get(scope="medlake-kv", key="eventhub-name")
sasl_password = dbutils.secrets.get(scope="medlake-kv", key="eventhub-sasl-password")
target = f"{catalog}.bronze.screening_events_stream"
jaas = (
